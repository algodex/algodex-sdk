...
const algoDelegateTemplate = require(
    '../order/teal/templates/ALGO_Delegate.template.teal',
);
const algoDelegateTemplateV4 = require(
    '../order/teal/templates/ALGO_Delegate_v4.template.teal',
);
const algoDelegateTemplateV5 = require(
    '../order/teal/templates/ALGO_Delegate_v5.template.teal',
);
const algoDelegateTemplateV6 = require(
    '../order/teal/templates/ALGO_Delegate_v6.template.teal',
);
const algoDelegateTemplateV7 = require(
    '../order/teal/templates/ALGO_Delegate_v7.template.teal',
);
const asaDelegateTemplate = require(
    '../order/teal/templates/ASA_Delegate.template.teal',
);
const asaDelegateTemplateV4 = require(
    '../order/teal/templates/ASA_Delegate_v4.template.teal',
);
const asaDelegateTemplateV5 = require(
    '../order/teal/templates/ASA_Delegate_v5.template.teal',
);
const asaDelegateTemplateV6 = require(
    '../order/teal/templates/ASA_Delegate_v6.template.teal',
);
// const asaDelegateTemplateV7 = require(
// '../order/teal/templates/ASA_Delegate_v7.template.teal
// ');
