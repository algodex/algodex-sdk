...
// Zero Refactor regex: ((?=[A-z])\w+): function
// Zero Refactor replace: SomeExport.prototype.$1 = function
 ...
 *
 */
AlgodexApi.prototype.doAlert = function doAlert() {
    alert(1);
 ...
 */
AlgodexApi.prototype.allSettled = function (promises) {
 ...
 */
AlgodexApi.prototype.initSmartContracts = function (environment) {
 ...
 * @returns {number}
 */
AlgodexApi.prototype.getOrderBookId = function (isAlgoEscrowApp) {
    if (isAlgoEscrowApp) {
 ...
 */
AlgodexApi.prototype.getMinWalletBalance = async function (accountInfo, includesFullAccountInfo = false) {
 ...
 */
AlgodexApi.prototype.initIndexer = function (environment) {
    let server = null;
    let port = null;
    let token = null;
 ...
 */
AlgodexApi.prototype.initAlgodClient = function (environment) {
...
AlgodexApi.prototype.waitForConfirmation = async function (txId) {
    return dexInternal.waitForConfirmation(txId);
};

AlgodexApi.prototype.dumpVar = dexInternal.dumpVar;
 ...
 */
AlgodexApi.prototype.getNumeratorAndDenominatorFromPrice = function getNumeratorAndDenominatorFromPrice(limitPrice) {
 ...
 */
AlgodexApi.prototype.createOrderBookEntryObj = function createOrderBookEntryObj(blockChainOrderVal, price, n, d, min, escrowAddr,
 ...
 */
AlgodexApi.prototype.getCutOrderTimes = function (queuedOrder) {
 ...
 */
AlgodexApi.prototype.executeOrder = async function executeOrder(algodClient, isSellingASA, assetId,
    ...
    if (!!walletConnector && walletConnector.connector.connected) {
        const confirmedWalletConnectArr = await this.signAndSendWalletConnectTransactions(
            algodClient,
            allTransList,
            params,
            walletConnector
 ...
 */
AlgodexApi.prototype.closeOrderFromOrderBookEntry = async function closeOrderFromOrderBookEntry(
    algodClient,
    escrowAccountAddr,
    creatorAddr,
    orderBookEntry,
 ...
 * @param txns
 */
AlgodexApi.prototype.assignGroups = function assignGroups(txns) {
 ...
 * @param isSellingASA
 */
AlgodexApi.prototype.finalPriceCheck = function finalPriceCheck(algoAmount, asaAmount, limitPrice, isSellingASA) {
 ...
 * @returns {[*,*]}
 */
AlgodexApi.prototype.getAlgoandAsaAmounts = function (txnList) {
    const algo = txnList
        .filter(
            (txObj) => {
...
AlgodexApi.prototype.signAndSendWalletConnectTransactions = async function (algodClient, outerTxns, params, walletConnector) {
...
AlgodexApi.prototype.signAndSendTransactions = async function signAndSendTransactions(algodClient, outerTxns) {
 ...
 * @returns {string}
 */
AlgodexApi.prototype.generateOrder = function (makerWalletAddr, n, d, min, assetId, includeMakerAddr) {
 ...
 * @returns {Promise<*[]|*>}
 */
AlgodexApi.prototype.getPlaceAlgosToBuyASAOrderIntoOrderbook = async function
 ...
 */
AlgodexApi.prototype.executeMarketOrder = function () {
    return this.executeOrder(...arguments);
};
 ...
 * @returns {Promise<*[]|*>}
 */
AlgodexApi.prototype.getPlaceASAToSellASAOrderIntoOrderbook =
 ...
 * @returns {String}
 */
AlgodexApi.prototype.printTransactionDebug = function printTransactionDebug(signedTxns) {
 ...
 * @returns {*|null}
 */
AlgodexApi.prototype.buildDelegateTemplateFromArgs = function buildDelegateTemplateFromArgs(min, assetid, N, D, writerAddr, isASAEscrow, version = 3) {
 ...
 * @returns {Promise<*>}
 */
AlgodexApi.prototype.getLsigFromProgramSource = async function getLsigFromProgramSource(algosdk, algodClient, program, logProgramSource) {
 ...
 */
AlgodexApi.prototype.getAccountInfo = async function getAccountInfo(accountAddr) {
