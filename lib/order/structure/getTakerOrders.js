 ...
 * * # 🏃 getTakerOrders
 *
 * Takes an {@link Order} and generates the corresponding executable taker order if it exists in the orderbook.
 *
 ...
 *
 * **Description:** An array of length=1 containing {@link Order} object with an txnArr attached to the contract
 *
 *
 * ### MultiOrderExececution
 * **Condition:** For when the desired user total amount is greater than the available escrow amount
 *
 * **Description:** An array of variable length.  Each item represents a group of transactions.
 *
 * @example
 *
 ...
 * [withExecuteAssetOrderTxns]{@link module:txns/sell.withExecuteAssetOrderTxns} || [withExecuteAlgoOrderTxns]{@link module:txns/buy.withExecuteAlgoOrderTxns}
 * @param {AlgodexApi} api The Algodex API
 * @param {Order} order The User's Order
 * @return {Promise<Structure[]>}
 * @see [makeExecuteAssetTxns]{@link module:txns/sell.makeExecuteAssetTxns} || [makeExecuteAlgoTxns]{@link module:txns/buy.makeExecuteAlgoTxns} ||  [withExecuteAssetOrderTxns]{@link module:txns/sell.withExecuteAssetOrderTxns} || [withExecuteAlgoOrderTxns]{@link module:txns/buy.withExecuteAlgoOrderTxns}
