...
/**
 * @deprecated
 * @type {{setClient({client: *, [p: string]: *}): void, getAllEscrowOrders: (function(*): *), placeOrder({order: Object, orders?: Object, config?: Object}): Promise<*[]|undefined>, placeOrderOriginal(*, *, *, *=): (Promise<*>|Promise<*|undefined>|Promise<*[]|*>), constructor({config: *}): void, closeOrder: (function(*, String, String, String, int): void), getOrders()}}
 */
const OrderService = {
  /**
   * @deprecated
   ...
   * @return {Promise<*>|Promise<undefined|*>|Promise<*[]|*>|Promise<*>}
   * @deprecated
   */
