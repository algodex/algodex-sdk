...
function getWalletAssetAmount(accountInfo, assetId) {
  ...
  // There is an edgecase where the above query returns undefined.
  // This happens when an account has an algo balance but has not opted into any assets, rare but important to handle.
  if (typeof matchingAssetArr === 'undefined') return 0;
