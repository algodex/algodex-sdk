 ...
 * SingleOrderExecution-- For when the desired user total amount is less than the available escrow amount
 * MultiOrderExececution-- For when the desired user total amount is larger than the available escrow amount
 *
 * You can think of the return array as a collection of taker transactions associated with the order. Each item has txns attached to the contract.
 * Txns are the return of {@link makeExecuteAssetTxns || makeExecuteAlgoTxns}
