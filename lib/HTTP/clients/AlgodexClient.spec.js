  ...
  describe('AlgodexClient.prototype', ()=>{
    ...
    describe('Wallet', () => {
      ...
      it('should fetch wallet trade history', async ()=>{
        ...
        expect(api.mapTradeHistoryData(res.data)).toEqual([
          {
            'amount': '1',
            'date': '2022-03-30 05:59:31',
            'id': 19267953,
