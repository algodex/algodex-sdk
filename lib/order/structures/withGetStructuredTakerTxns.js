...
// ToDo: Think of the best way to compose this object with proper input amounts from takerObj
			...
			// 	amount: queuedOrder.isASAEscrow? takerOrderBalance.algoTradeAmount: takerOrderBalance.asaTradeAmount,
