...
const algoDelegateTemplateV7 = require('./ALGO_Delegate_v7.template.teal');
const algoDelegateTemplateV6 = require('./ALGO_Delegate_v6.template.teal');
const algoDelegateTemplateV5 = require('./ALGO_Delegate_v5.template.teal');
const algoDelegateTemplateV4 = require('./ALGO_Delegate_v4.template.teal');
const algoDelegateTemplate = require('./ALGO_Delegate.template.teal');
const asaDelegateTemplate = require('./ASA_Delegate.template.teal');
const asaDelegateTemplateV6 = require('./ASA_Delegate_v6.template.teal');
const asaDelegateTemplateV5 = require('./ASA_Delegate_v5.template.teal');
const asaDelegateTemplateV4 = require('./ASA_Delegate_v4.template.teal');
