...
const server = 'http://ec2-18-216-194-132.us-east-2.compute.amazonaws.com';
const port = 8080;
...
describe('getWalletAssetAmount', ()=> {
  it('should throw an error when given an accountObject with missing properties', async () => {
    expect(() => getWalletAssetAmount({'empty': 'Object'}, testAssetId )).toThrow('AccountInfo object must have amount and assets field ');
  });
