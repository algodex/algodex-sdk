...
module.exports = {
  ...
  ALGOD_SERVER: ('ALGODEX_ALGOD_SERVER' in process.env) ?
    process.env.ALGODEX_ALGOD_SERVER :
    'https://node.algoexplorerapi.io',
  ALGOD_PORT: ('ALGODEX_ALGOD_PORT' in process.env) ?
    process.env.ALGODEX_ALGOD_PORT :
    '',
  ALGOD_TOKEN: ('ALGODEX_ALGOD_TOKEN' in process.env) ?
    process.env.ALGODEX_ALGOD_TOKEN :
    '',
  BACKEND_API: 'https://app.algodex.com/algodex-backend',
