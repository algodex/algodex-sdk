...
const {getAccountInfo} = require('./indexer')
...
const algoDelegateTemplate = require('../teal/algo_delegate_template_teal.js');
const algoDelegateTemplateV4 = require('../teal/algo_delegate_template_teal_v4.js');
const algoDelegateTemplateV5 = require('../teal/algo_delegate_template_teal_v5.js');
const algoDelegateTemplateV6 = require('../teal/algo_delegate_template_teal_v6.js');
const algoDelegateTemplateV7 = require('../teal/algo_delegate_template_teal_v7.js');
const asaDelegateTemplate = require('../teal/ASA_delegate_template_teal.js');
const asaDelegateTemplateV4 = require('../teal/ASA_delegate_template_teal_v4.js');
const asaDelegateTemplateV5 = require('../teal/ASA_delegate_template_teal_v5.js');
const asaDelegateTemplateV6 = require('../teal/ASA_delegate_template_teal_v6.js');
const asaDelegateTemplateV7 = require('../teal/ASA_delegate_template_teal_v7.js');
//require('./dex_teal.js');
...
const AlgodexInternalApi = {
     ...
     * @param x
     * @returns {string}
     * @todo: create object toString prototypes
     */
...
// ***
     ...
     * @param orderBookEscrowEntry
     * @param takerCombOrderBalance
     * @returns {{algoAmountReceiving: number, txnFee: number, asaAmountSending: number}}
     */
