...
async function makeExecuteAssetTxns(
  ...
  // TODO use optIn
  const _optedIn = await getOptedIn(order.indexer, {address: order.wallet.address}, order.asset.id); // why are we passing the address when the method expects an object?
