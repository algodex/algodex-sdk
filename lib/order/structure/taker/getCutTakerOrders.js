    ...
    //  queuedOrder.algoBalance - updatedTakerOrderBalance.algoAmountReceiving < 500000
      const compiledEscrowWithTxns =
                !queuedOrder.isASAEscrow ?
                    ...
                    await withExecuteAssetTxns(withTakerBalanceAmounts(withUserWallet(order.wallet, compiledEscrow), updatedTakerOrderBalance), (updatedTakerOrderBalance.closeOutFromASA));
