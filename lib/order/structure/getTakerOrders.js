...
async function getTakerOrders(api, order) {
  ...
  // I think for _order.type === 'sell' it should be:
  // _order.amount > firstOrderBalance but have to think about it
  // or we need to change firstOrder.asaBalance * firstOrder.price
