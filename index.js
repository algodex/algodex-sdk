 ...
 */
exports.createOrderBookEntryObj = function (
  blockChainOrderVal,
  price,
  n,
  d,
  ...
  return algodex.createOrderBookEntryObj(
    blockChainOrderVal,
    price,
    n,
    d,
 ...
 */
exports.executeOrderAsTaker = function (
  algodClient,
 ...
 * @returns {Object} Promise for when the batched transaction(s) are fully confirmed
 */
exports.executeOrderAsMakerAndTaker = function (
  algodClient,
  isSellingASA,
  assetId,
  userWalletAddr,
 ...
 */
exports.closeOrderFromOrderBookEntry = function (
  algodClient,
  escrowAccountAddr,
  creatorAddr,
  orderBookEntry,
  ...
  return algodex.closeOrderFromOrderBookEntry(
    algodClient,
    escrowAccountAddr,
    creatorAddr,
    orderBookEntry,
...
exports.placeAlgosToBuyASAOrderIntoOrderbook = function (
  algodClient,
  makerWalletAddr,
  n,
  d,
  ...
  return algodex.getPlaceAlgosToBuyASAOrderIntoOrderbook(
    algodClient,
    makerWalletAddr,
    n,
    d,
 ...
 * @returns {Object} Promise for when the transaction is fully confirmed
 */
exports.placeASAToSellASAOrderIntoOrderbook = function (
  algodClient,
  makerWalletAddr,
  n,
  d,
  ...
  return algodex.getPlaceASAToSellASAOrderIntoOrderbook(
    algodClient,
    makerWalletAddr,
    n,
    d,
...
////////////////////////////////////
exports.buildDelegateTemplateFromArgs = function (
  min,
  assetid,
  N,
  D,
  ...
  return algodex.buildDelegateTemplateFromArgs(
    min,
    assetid,
    N,
    D,
...
exports.getLsigFromProgramSource = function (
  algosdk,
  algodClient,
  program,
  logProgramSource
) {
  return algodex.getLsigFromProgramSource(
    algosdk,
    algodClient,
    program,
    logProgramSource
