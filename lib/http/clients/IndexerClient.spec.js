...
const constructedIndexer = new algosdk.Indexer(apiProps.config.indexer.token, apiProps.config.indexer.uri, '');
// Combined Integration and Unit Tests
describe('http/clients/IndexerClient', ()=>{
  // Statics and Construction
  it('should construct an instance', ()=>{
    api = new IndexerClient(BASE_URL, false, apiProps.config, constructedIndexer);
