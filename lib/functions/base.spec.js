...
// const allOrderBookOrders = orderBookEntry;
...
test.skip('getConstants', () => {
  expect(base.getConstants()).toBeTruthy();
});

test.skip('getOrderBookId', () => {
...
test.skip('createOrderBookEntryObject', () => {
...
test.skip('getPlaceAlgosToBuyASAOrderIntoOrderbook', async () => {
  const client = base.initAlgodClient('test');
...
test.skip('getPlaceASAToSellASAOrderIntoOrderbook', async () => {
  const client = base.initAlgodClient('test');
