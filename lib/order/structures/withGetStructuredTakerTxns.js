...
const {getExecuteOrderTransactionsAsTakerFromOrderEntry, getAlgoandAsaAmounts, finalPriceCheck} = require('../../functions/base');
 ...
 */
async function withGetStructuredTakerTxns(takerOrderBalance, queuedOrders, isSellingASA) {
  let txOrderNum = 0;
  let groupNum = 0;
  ...
  return {allTransList, currentOrderValues: {lastExecutedPrice, groupNum, txOrderNum}};
}
