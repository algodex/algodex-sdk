...
const withMakerAndTaker = require('./structures/structureRefreshed');
...
async function structure(state) {
  if (!(state?.client instanceof algosdk.Algodv2)) throw new TypeError('Must have valid algod client!!!');
