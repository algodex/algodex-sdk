...
const testHelper = require('../__test__/setup.js');
const algosdk = require('algosdk');
const CONSTANTS = require('../constants.js');
const orderBookEntry = require('../__test__/fixtures/allOrderBooks.js');
...
const internalTests = require('../__test__/integration_tests/AlgodexInternal.js');
